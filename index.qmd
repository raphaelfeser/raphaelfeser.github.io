...
description: "<p align='left'>Pharmacist by training with a passion for research, I am currently pursuing a PhD in Biomolecular and Pharmaceutical Modelling. I'm using computers to describe complex biological mechanisms and, ultimately, to **design new medicines**. 💊 <br><br> With diverse experiences across institutions in Geneva (UNIGE), Sydney (USYD & MIA), and London (UCL), I have developed a range of skills in **Medicinal Chemistry**, **Cheminformatics**, **Statistical Modelling**, and **Machine Learning**. 💻🔬<br>"
image: moi.png
format:
  html:
    toc: false
