---
title: "Melanoma outcomes and survival analysis"
format:
  html:
    toc: false
...
```{=html}
<meta name="description" content="Interactive explainer for melanoma outcomes research, showing the survival analysis ideas used to study sentinel lymph node biopsy and related variables.">
...
<div class="survival-page">
  ...
  <div class="survival-header">
    <p class="surv-eyebrow">Previous and ongoing research &middot; Melanoma outcomes</p>
    <h1>Melanoma outcomes and survival analysis</h1>
    <p class="surv-subtitle">
      This project asks whether sentinel lymph node biopsy (SLNB) is justified by measurable
      improvement in outcomes, given that surgical procedures also carry risks. The page is an
      illustrative walkthrough of the statistical ideas used to study that question in melanoma
      cohorts. The data shown here are simulated for demonstration purposes, and results from the
      underlying cohorts are to be reported separately in peer-reviewed publications.
    </p>
  </div>
  ...
  <div class="surv-section">
    ...
    <p>
      For readability, the panel below shows 40 illustrative patients; the underlying cohorts include several thousand patients.
    </p>
