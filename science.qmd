---
title: "Receptor signalling and molecular mechanisms"
format:
  html:
    toc: false
...
```{=html}
<meta name="description" content="Interactive walkthrough of current PhD research on receptor signalling, using CCR5 as a case study for molecular mechanisms relevant to therapeutics.">
...
<div class="science-page">
  ...
  <div class="science-page-header">
    <h1>Receptor signalling and molecular mechanisms</h1>
    <p>In my current PhD work, I use CCR5 as a case study to examine how closely related molecules can bind the same immune-cell receptor yet trigger different cellular responses.</p>
    <p class="research-context-note">Public reference structures (PDB: 5UIW, 7O7F)</p>
  </div>
  ...
  <div class="science-chapter active" id="chapter-0">
    ...
    <div class="chapter-body">
      <p>
        ...
        it is relevant in inflammatory disease and cancer contexts.
      </p>
      <p>
  ...
  <div class="science-chapter" id="chapter-2">
    ...
    <div class="chapter-body">
      <p>
        ...
        this movement does not occur. This suggests that activation depends on binding location, but also
        on the shape changes the receptor undergoes afterward.
      </p>
  ...
  <div class="science-chapter" id="chapter-3">
    ...
    <div class="chapter-body">
      ...
      <p>
        ...
        understand how ligand binding reshapes receptor dynamics and shifts the balance between
...
<div class="enh-section">
  ...
  <p>
    ...
    the unbiased distribution through reweighting. The &Delta;G slider below sketches how a ligand or mutation shifts
